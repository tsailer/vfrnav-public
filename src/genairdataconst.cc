...
int main(int argc, char *argv[])
{
	std::cout << "// do not edit, automatically generated by genairdataconst.cc" << std::endl << std::endl
		  ...
		  << AirData<float>::get_lss(IcaoAtmosphere<float>::std_sealevel_temperature - IcaoAtmosphere<float>::degc_to_kelvin)
		  << ";" << std::endl
		  << "template<> constexpr typename AirData<double>::float_t AirData<double>::speed_of_sound_std = "
		  << AirData<double>::get_lss(IcaoAtmosphere<double>::std_sealevel_temperature - IcaoAtmosphere<double>::degc_to_kelvin)
		  << ";" << std::endl;
	return 0;
}
